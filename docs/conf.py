...
latex_documents = [
    ('index', 'nlabpy.tex',
     'nlabpy: scripts, functions and viz tools for NGS data',
     'Nudlerlab', 'manual'),
]
...
# extlinks alias
extlinks = {'issue': ('https://github.com/eco32i/nlabpy/issues/%s',
                      'GH')}
